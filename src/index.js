        ...
        switch(message_array[0].toLowerCase()) {
            ...
            case 'help': {
                if(checkCoolDown('help')) {
                    ...
                    client.say(channel, tags["display-name"] + ' у бота есть такие команды как: !пиво, !монетка, !скучно, !вопрос, !rr, !правила, !создатель');
                }
                break;
            }
            case 'hunt':
            case 'правила': {
                if(checkCoolDown('правила')) {
                    break;
                } else {
                    client.say(channel, tags["display-name"] + ' для того что бы участвовать в охоте вам понадобится лицензия охотника, которую можно получить написав команду "!охотник". (При участии у вас есть шанс получить бобра в вашем инвентаре если он вам выпадет во время стрима)');
                }
                break;
            }
            case 'source':
